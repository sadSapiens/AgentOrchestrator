...
class CoordinatorAgent(BaseAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            ВАЖНО: Если задачи можно выполнять параллельно (они не зависят друг от друга), 
            присвой им ОДИНАКОВЫЙ номер шага (step).
            Например:
            { "step": 1, ... } - исследователь ищет информацию по теме А
            { "step": 1, ... } - исследователь ищет информацию по теме Б
            { "step": 2, ... } - аналитик анализирует всё вместе
